...
function CheckoutPage() {
    ...
    const handlePlaceOrder = async ()=>{
        ...
        let resolvedStoreId = latestProfile?.storeId || user?.storeId;
        if (!resolvedStoreId) {
            const store = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getStoreFromSubdomain"])();
            resolvedStoreId = store?._id || "";
        }
        if (!resolvedStoreId) {
            toast({
                title: "Store not found",
                description: "Unable to resolve store information. Please try again.",
                variant: "destructive"
            });
            return;
        }
...
//# sourceMappingURL=_f24eca2d._.js.map